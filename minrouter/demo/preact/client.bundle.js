...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return Component; });
...
let exec = (() => {
  var _ref = _asyncToGenerator(function* () {
    ...
    for (var i = 0; i < data.routes.length; i++) {
      ...
      yield data.routes[i].fn.call(data, data.req, data.res, data.next);
    }
    if (!match && typeof data.next === 'function') yield data.next();
  });
...
let Router = (() => {
  var _ref2 = _asyncToGenerator(function* (req, res, next) {
    ...
    data.env === 'browser' ? emit() : yield exec();
  });
...
var regexps = [/[\-{}\[\]+?.,\\\^$|#\s]/g, /\((.*?)\)/g, /(\(\?)?:\w+/g, /\*\w+/g];

function extractRoute(route) {
  var matchs = [];
  route = route.replace(regexps[0], '\\$&').replace(regexps[1], '(?:$1)?').replace(regexps[2], function (match, optional) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_preact__ = __webpack_require__(126);


class Navigator extends __WEBPACK_IMPORTED_MODULE_0_preact__["c" /* Component */] {
  render() {
    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["b" /* h */])(
      "ul",
      null,
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["b" /* h */])(
        "li",
        null,
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["b" /* h */])(
          "a",
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_preact__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_home__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_about__ = __webpack_require__(333);
...
router.addResMethod('view', function (component) {
  ...
  app.innerHTML = '';
  if (component === 'Home') {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* render */])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["b" /* h */])(__WEBPACK_IMPORTED_MODULE_1__pages_home__["a" /* default */], null), app);
  } else if (component === 'About') {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* render */])(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["b" /* h */])(__WEBPACK_IMPORTED_MODULE_2__pages_about__["a" /* default */], null), app);
  }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_preact__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_navigator__ = __webpack_require__(329);



class About extends __WEBPACK_IMPORTED_MODULE_0_preact__["c" /* Component */] {
  constructor() {
    super();
    // set initial time:
  ...
  render(props, state) {
    ...
    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["b" /* h */])(
      'div',
      null,
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["b" /* h */])(__WEBPACK_IMPORTED_MODULE_1__components_navigator__["a" /* default */], null),
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["b" /* h */])(
        'div',
        null,
        time
...
class Hello extends __WEBPACK_IMPORTED_MODULE_0_preact__["c" /* Component */] {
  componentDidMount() {
    var _this = this;

    return _asyncToGenerator(function* () {
      let stars = 500;
      _this.setState({ stars });
    })();
  }
  render({ repo }, { stars = 0 }) {
...
var router = __webpack_require__(328);
